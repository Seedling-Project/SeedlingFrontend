        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/2', 'MATH-171: Calculus I')
              }
            >
              <th>2</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/3', 'MATH-172: Calculus II')
              }
            >
              <th>3</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/4', 'MATH-173: Calculus III and IV')
              }
            >
              <th>4</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/5', 'MATH-191: Linear Algebra')
              }
            >
              <th>5</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/7', 'MATH-134: Elementary Statistics')
              }
            >
              <th>7</th>
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/8', 'PHYS-101: Mechanics')
              }
            >
              <th>1</th>
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/11', 'CHEM-101: Chemistry I')
              }
            >
              <th>1</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/12', 'CHEM-102: Chemistry II')
              }
            >
              <th>2</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/13', 'CHEM-112: Organic Chemistry I')
              }
            >
              <th>3</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/14', 'CHEM-113: Organic Chemistry II')
              }
            >
              <th>4</th>
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/15', 'BIO-101: Biological Principles')
              }
            >
              <th>1</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/16', 'BOT-101: General Botany')
              }
            >
              <th>2</th>
            ...
            <tr
              className="hover:cursor-pointer"
              onClick={() =>
                handleRowClick('/classes/17', 'ZOOL-101: General Zoology')
              }
            >
              <th>3</th>
