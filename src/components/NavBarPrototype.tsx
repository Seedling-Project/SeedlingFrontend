...
const Prototype = () => {
  ...
  <div className="navbar-start  lg:justify-start flex justify-around items-center w-full">
    <div className="dropdown mr-100px">
      <div tabIndex={0} role="button" className="btn  btn-ghost margin lg:hidden">
    ...
    <a className="btn btn-ghost text-xl lg:text-center hidden md:unhidden :block" >Seedling Education</a> 
